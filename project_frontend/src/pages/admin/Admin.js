              ...
              <nav>
                <div>
                  ...
                  >
                    ...
                    <span className="mx-4 text-sm font-normal" href="/CourseDash">
                      Dashboard
                    </span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="mx-4 text-sm font-normal">Testimonial</span>
                  </a>
                  <a
                    className="w-full font-thin uppercase text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500"
                  ...
                  >
                    ...
                    <span className="mx-4 text-sm font-normal">Partnership</span>
                  </a>
                  <a
                    className="w-full font-thin uppercase text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500"

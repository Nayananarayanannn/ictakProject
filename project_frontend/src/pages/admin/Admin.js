      ...
      <main class="bg-white  relative h-screen">
        <div class="flex items-start justify-between  ">
          <div class="   lg:block ml-4 shadow-lg relative w-80 overscroll-auto ">
            <div class="overflow-hidden rounded-2xl bg-gray-700" style={{height:"112vh"}}>
              ...
              <nav class="mt-2 ">
                <div>
                  <a
                    class="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 from-gray-700 to-gray-800 border-r-4 border-blue-500 "
                    href="#"
                  >
          ...
          <div class="flex flex-col w-full pl-0 md:p-4 md:space-y-4 ">
            <header class="w-full shadow-lg bg-gray-700 items-center h-16 rounded-2xl z-40 ">
                ...
                <div class="relative items-center pl-1 flex w-full lg:max-w-68 sm:pr-2 sm:ml-0 ">
                  <div class="container relative left-0 z-50 flex w-3/4 h-auto h-full ">
                    <div class="relative flex items-center w-full lg:w-64 h-full group ">
                      ...
                      <input
                        type="text"
                        class="block w-full py-1.5 pl-10 pr-4 leading-normal rounded-2xl focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 ring-opacity-90 bg-gray-800 text-gray-400 aa-input"
                        placeholder="Search"
                      />
